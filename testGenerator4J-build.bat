...
%JAVA_HOME%\bin\java -cp %TESTGENERATOR4J_CP%;%CLASSPATH%;%1;. classdoc -doclet generator.code.DocletTestGenerator -d %TEST_DIR%\ -docpath %1

echo "Compiling the Test Cases, please wait....."
%JAVA_HOME%\bin\javac -cp %TESTGENERATOR4J_CP%;%CLASSPATH%;%1;. %TEST_DIR%\*.java
