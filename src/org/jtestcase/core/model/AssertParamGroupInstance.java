 ...
 * 
 * $Id: AssertParamGroupInstance.java,v 1.1 2005/10/12 20:20:08 faustothegrey Exp $
 */
...
implements IUINode
{
	...
	public AssertParamGroupInstance(String name) {
		this.name = name;
     ...
     */
	public List getAssertParamInstances() {
     ...
     */
	public List getAssertParamGroupInstances (){
	...
	public String toString() {
		...
		for (Iterator iter = assertGroupNestedInstances.iterator(); iter.hasNext();) {
			AssertParamGroupInstance assertGroupInstance = (AssertParamGroupInstance) iter.next();
			retval+=("\t " + assertGroupInstance.toString() + "\n");
		}
		for (Iterator iter = assertNestedInstances.iterator(); iter.hasNext();) {
			AssertParamInstance assertInstance = (AssertParamInstance) iter.next();
